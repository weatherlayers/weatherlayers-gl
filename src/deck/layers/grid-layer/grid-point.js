 ...
 * @returns {GridPoint[]}
 */
export function getGridPoints(image, image2, imageWeight, imageType, positions, bounds) {
  ...
  for (let position of positions) {
    ...
    const pixel11 = getPixel(image, point[0], point[1], 0);
    const pixel12 = getPixel(image, point[0], point[1], 1);
    const pixel21 = image2 ? getPixel(image2, point[0], point[1], 0) : null;
    const pixel22 = image2 ? getPixel(image2, point[0], point[1], 1) : null;
