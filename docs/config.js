...
const DATASETS_WEATHER_WIND = [
  ...
  ...[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500, 450, 400, 350, 300, 250, 200, 150, 100, 50].map(level => `gfs/wind_${level}hpa`),
  'gfs/wind_tropopause',
  'gfs/wind_gust_surface',
  'hrrr_conus/wind_10m_above_ground',
  'hrrr_conus/wind_80m_above_ground',
  ...[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500, 450, 400, 350, 300, 250, 200, 150, 100, 50].map(level => `hrrr_conus/wind_${level}hpa`),
  'hrrr_conus/wind_gust_surface',
  'hrrr_alaska/wind_10m_above_ground',
  'hrrr_alaska/wind_80m_above_ground',
  ...[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500, 450, 400, 350, 300, 250, 200, 150, 100, 50].map(level => `hrrr_alaska/wind_${level}hpa`),
  'hrrr_alaska/wind_gust_surface',
  'ecmwf_ifs/wind_10m_above_ground',
  'ecmwf_ifs/wind_100m_above_ground',
  ...[1000, 925, 850, 700, 600, 500, 400, 300, 250, 200, 150, 100, 50].map(level => `ecmwf_ifs/wind_${level}hpa`),
  'ecmwf_ifs/wind_gust_surface',
  'ecmwf_aifs/wind_10m_above_ground',
  'ecmwf_aifs/wind_100m_above_ground',
  ...[1000, 925, 850, 700, 600, 500, 400, 300, 250, 200, 150, 100, 50].map(level => `ecmwf_aifs/wind_${level}hpa`),
